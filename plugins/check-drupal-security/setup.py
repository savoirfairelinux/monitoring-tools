...
long_description = ('''A plugin to monitor Drupal security''')

#############################################################################

setup(
    name='shinkenplugins.plugins.drupal_security',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_drupal_security = shinkenplugins.plugins.drupal_security:main
    """
)