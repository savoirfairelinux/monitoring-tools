...
# Copyright (C) 2014, Flavien Peyre <flavien.peyre@savoirfairelinux.net>

import unittest

from shinkenplugins.test import TestPlugin

from shinkenplugins.plugins.rabbit_consumer_utilisation import Plugin


class Testrabbit_consumer_utilisation(TestPlugin):
    def setUp(self):
