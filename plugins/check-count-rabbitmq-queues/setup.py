...
long_description = ('''check the number of queue on a rabbitmq server''')

#############################################################################

setup(
    name='shinkenplugins.plugins.count_rabbitmq_queues',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_count_rabbitmq_queues = shinkenplugins.plugins.count_rabbitmq_queues:main
    """
)