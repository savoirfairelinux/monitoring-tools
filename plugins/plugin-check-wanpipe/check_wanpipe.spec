...
#
%define raw_name    check_wanpipe
%define name        check-wanpipe
...
License: GPL v3
Summary: Shinken plugin from SFL. Check channels in error with wanpipe
...
%{__cp} -pr check_wanpipe %{buildroot}/%{_libdir}/shinken/plugins/check_wanpipe
...
%{_libdir}/shinken/plugins/check_wanpipe
%doc
