%define raw_name       check-ceilometer
%define name           monitoring-plugins-sfl-%{raw_name}
%define version        0.4.0
%define release        1
%define command_name   check_ceilometer

Name:           %{name}
Version:        %{version}
Release:        %{release}
Summary:        Alignak plugin to use OpenStack Ceilometer API for metering
...
%description
Alignak plugin to use OpenStack Ceilometer API for metering
