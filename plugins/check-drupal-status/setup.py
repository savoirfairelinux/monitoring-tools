...
long_description = ('''A plugin to monitor Drupal status''')

#############################################################################

setup(
    name='shinkenplugins.plugins.drupal_status',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_drupal_status = shinkenplugins.plugins.drupal_status:main
    """
)