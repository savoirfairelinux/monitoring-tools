...
Name:           monitoring-plugins-sfl-check-drupal-status
Version:        2015.5.25.16.50
Release:        1%{?dist}
Summary:        A plugin to monitor Drupal status

License:        GPLv3
URL:            https://github.com/savoirfairelinux/monitoring-tools
Source0:        https://github.com/savoirfairelinux/monitoring-tools/monitoring-plugins-sfl-check-drupal-status_%{version}.orig.tar.gz
...
%description
A plugin to monitor Drupal status
More information is available on Github:
https://github.com/savoirfairelinux/sfl-monitoring-tools

%prep
%setup -q -n monitoring-plugins-sfl-check-drupal-status
...
%{__install} -p -m0755 check_drupal_status %{buildroot}/%{_libdir}/monitoring/plugins/sfl
...
%{python_sitelib}/shinkenplugins/plugins/drupal_status
%{_libdir}/monitoring/plugins/sfl/check_drupal_status
%docdir
%{_docdir}/monitoring/plugins/%{name}
%{_mandir}/man1/monitoring/plugins/%{name}

%changelog
* Mon May 25 2015 Frédéric Vachon <frederic.vachon@savoirfairelinux.com> - 2015.5.25.16.50
- Initial package