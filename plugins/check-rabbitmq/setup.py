...
long_description = ('''Verify good behavior of a RabbitMQ exchange and queue''')

#############################################################################

setup(
    name='shinkenplugins.plugins.rabbitmq',
    version="1.0",
    packages=find_packages(),
    author="Grégory Starck",
    author_email="g.starck@gmail.com",
    ...
    entry_points="""
    [console_scripts]
    check_rabbitmq = shinkenplugins.plugins.rabbitmq:main
    """
)