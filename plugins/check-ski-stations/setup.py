...
description = 'Check Ski Stations traffic'
long_description = ('''Check Ski Stations traffic''')

#############################################################################

setup(
    name='shinkenplugins.plugins.ski_stations',
    ...
    entry_points="""
    [console_scripts]
    check_ski_stations = shinkenplugins.plugins.ski_stations:main
    """,
)
