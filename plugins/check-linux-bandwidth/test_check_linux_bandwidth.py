...
class Test(TestPlugin):
    def setUp(self):
        if os.path.exists("/tmp/check_linux_bandwidth"):
            shutil.rmtree("/tmp/check_linux_bandwidth")
    ...
    # check_linux_bandwidth_usage -i lo -W 50 -C 90 -d 10 -l 500
    ...
    # check_linux_bandwidth_usage -i lo -W 50 -C 90 -d 10 -l 500 -f
    ...
    def test_warning_percent_perf_critical(self):
     ...
     # check_linux_bandwidth_usage -i lo -w 50 -c 100 -d 10 -l 500 -f
    ...
    def test_warning_gb_limit_perf_critical(self):
     ...
     # check_linux_bandwidth_usage -i lo -w 50 -c 90 -d 5
    ...
    # check_linux_bandwidth_usage -i lo -w 50 -c 90 -d 5 -f
    ...
    def test_warning_gb_perf_critical(self):
     ...
     # check_linux_bandwidth_usage -i lo -W 50 -C 90 -d 10 -l 500 -s /tmp/
