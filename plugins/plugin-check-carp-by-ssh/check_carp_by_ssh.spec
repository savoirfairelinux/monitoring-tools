...
#
%define raw_name    check_carp_by_ssh
%define name        check-carp-by-ssh
...
License: GPL v3
Summary: Shinken plugin from SFL. Check carp status on Soekris using ssh
...
%{__cp} -pr check_carp_by_ssh %{buildroot}/%{_libdir}/shinken/plugins/check_carp_by_ssh
...
%{_libdir}/shinken/plugins/check_carp_by_ssh
%doc
