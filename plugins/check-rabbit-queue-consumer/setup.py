...
long_description = ('''check the number of consumer on a rabbitMQ queue''')

#############################################################################

setup(
    name='shinkenplugins.plugins.rabbit_queue_consumer',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_rabbit_queue_consumer = shinkenplugins.plugins.rabbit_queue_consumer:main
    """
)