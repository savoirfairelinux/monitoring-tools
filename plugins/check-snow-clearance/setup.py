...
description = 'Check Snow Clearance'
long_description = ('''Check Snow Clearance''')

#############################################################################

setup(
    name='shinkenplugins.plugins.snow_clearance',
    ...
    entry_points="""
    [console_scripts]
    check_snow_clearance = shinkenplugins.plugins.snow_clearance:main
    """,
)
