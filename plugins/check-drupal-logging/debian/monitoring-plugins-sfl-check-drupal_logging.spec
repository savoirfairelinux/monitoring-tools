...
Name:           monitoring-plugins-sfl-check-drupal-logging
Version:        2015.5.25.17.51
Release:        1%{?dist}
Summary:        A plugin to monitor Drupal watchdog logging

License:        GPLv3
URL:            https://github.com/savoirfairelinux/monitoring-tools
Source0:        https://github.com/savoirfairelinux/monitoring-tools/monitoring-plugins-sfl-check-drupal-logging_%{version}.orig.tar.gz
...
%prep
%setup -q -n monitoring-plugins-sfl-check-drupal-logging
...
%{__install} -p -m0755 check_drupal_logging %{buildroot}/%{_libdir}/monitoring/plugins/sfl
...
%{python_sitelib}/shinkenplugins/plugins/drupal_logging
%{_libdir}/monitoring/plugins/sfl/check_drupal_logging
%docdir
%{_docdir}/monitoring/plugins/%{name}
%{_mandir}/man1/monitoring/plugins/%{name}

%changelog
* Mon May 25 2015 Frédéric Vachon <frederic.vachon@savoirfairelinux.com> - 2015.5.25.17.51
- Initial package