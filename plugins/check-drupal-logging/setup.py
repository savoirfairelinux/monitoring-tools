...
long_description = ('''A plugin to monitor Drupal watchdog logging''')

#############################################################################

setup(
    name='shinkenplugins.plugins.drupal_logging',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_drupal_logging = shinkenplugins.plugins.drupal_logging:main
    """
)