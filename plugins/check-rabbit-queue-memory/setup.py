...
long_description = ('''Check the memory used by a rabbitmq queue''')

#############################################################################

setup(
    name='shinkenplugins.plugins.rabbit_queue_memory',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_rabbit_queue_memory = shinkenplugins.plugins.rabbit_queue_memory:main
    """
)