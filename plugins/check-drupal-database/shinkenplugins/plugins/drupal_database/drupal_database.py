...
class CheckDrupalDatabase(ShinkenPlugin):
    ...
    def _call_site_audit(self, path):
        ...
        out = subprocess.check_output(['drush', '--json', 'ad'],
                                      cwd=path,
                                      stderr=devnull)
    ...
    def parse_args(self, args):
        ...
        args = super(CheckDrupalDatabase, self).parse_args(args)
