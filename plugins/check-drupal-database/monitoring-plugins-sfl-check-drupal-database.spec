%define raw_name       check-drupal-database
%define name           monitoring-plugins-sfl-%{raw_name}
%define version        0.1.0
%define release        1
%define command_name   check_drupal_database

Name:           %{name}
Version:        %{version}
Release:        %{release}
Summary:        Alignak plugin to check the Drupal database service
...
%description
Alignak plugin to check the Drupal database service
