...
long_description = ('''A plugin to monitor Drupal database''')

#############################################################################

setup(
    name='shinkenplugins.plugins.drupal_database',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_drupal_database = shinkenplugins.plugins.drupal_database:main
    """
)