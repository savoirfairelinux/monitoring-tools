...
long_description = ('''Checks the size of an AWS sqs queue''')
...
setup(
    ...
    version="1.0",
    packages=["shinkenplugins.plugins.aws_sqs_queue_size"],
...
#    entry_points="""
#    [console_scripts]
#    check_aws_sqs_queue_size = shinkenplugins.plugins.aws_sqs_queue_size.aws_sqs_queue_size:main
#
#    """
)