...
description = 'Check AWS SQS queue size'
long_description = ''' ... '''
...
setup(
    ...
    name='shinkenplugins.plugins.aws_sqs_queue_size',
    version="1.2",
    ...
    entry_points="""
    [console_scripts]
    check_aws_sqs_queue_size = shinkenplugins.plugins.aws_sqs_queue_size:main
    """,
)
