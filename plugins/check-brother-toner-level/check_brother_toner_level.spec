...
#
%define raw_name    check_brother_toner_level
%define name        check-brother-toner-level
...
License: GPL v3
Summary: Shinken plugin from SFL. Check toner levels of Brother printer by http
...
%{__cp} -pr check_brother_toner_level %{buildroot}/%{_libdir}/shinken/plugins/check_brother_toner_level
...
%{_libdir}/shinken/plugins/check_brother_toner_level
%doc

%changelog
* Fri Feb 15 2013 Thibault Cohen <thibault.cohen@savoirfairelinux.com>
- Initial Release
