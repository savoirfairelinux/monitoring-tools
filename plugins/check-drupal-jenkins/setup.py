...
long_description = ('''A plugin to monitor Drupal last build using Jenkins API''')

#############################################################################

setup(
    name='shinkenplugins.plugins.drupal_jenkins',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_drupal_jenkins = shinkenplugins.plugins.drupal_jenkins:main
    """
)