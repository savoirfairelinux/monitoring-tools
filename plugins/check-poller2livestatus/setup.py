...
description = 'Check poller to Livestatus'
long_description = ''' ... '''
...
setup(
    ...
    name='shinkenplugins.plugins.poller2livestatus',
    version="1.2",
    ...
    entry_points="""
    [console_scripts]
    check_poller2livestatus = shinkenplugins.plugins.poller2livestatus:main
    """,
)
