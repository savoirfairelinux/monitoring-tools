...
#
%define raw_name    check_site_health
%define name        check-site-health
...
License: GPL v3
Summary: Shinken plugin from SFL. Browse web site to find broken links
...
%{__cp} -pr check_site_health %{buildroot}/%{_libdir}/shinken/plugins/check_site_health
...
%{_libdir}/shinken/plugins/check_site_health
%doc
