...
long_description = ('''A plugin to monitor Drupal extensions''')

#############################################################################

setup(
    name='shinkenplugins.plugins.drupal_extensions',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_drupal_extensions = shinkenplugins.plugins.drupal_extensions:main
    """
)