...
Name:           monitoring-plugins-sfl-check-drupal-extensions
Version:        2015.5.25.15.38
Release:        1%{?dist}
Summary:        A plugin to monitor Drupal extensions

License:        GPLv3
URL:            https://github.com/savoirfairelinux/monitoring-tools
Source0:        https://github.com/savoirfairelinux/monitoring-tools/monitoring-plugins-sfl-check-drupal-extensions_%{version}.orig.tar.gz
...
%prep
%setup -q -n monitoring-plugins-sfl-check-drupal-extensions
...
%{__install} -p -m0755 check_drupal_extensions %{buildroot}/%{_libdir}/monitoring/plugins/sfl
...
%{python_sitelib}/shinkenplugins/plugins/drupal_extensions
%{_libdir}/monitoring/plugins/sfl/check_drupal_extensions
%docdir
%{_docdir}/monitoring/plugins/%{name}
%{_mandir}/man1/monitoring/plugins/%{name}

%changelog
* Mon May 25 2015 Frédéric Vachon <frederic.vachon@savoirfairelinux.com> - 2015.5.25.15.38
- Initial package