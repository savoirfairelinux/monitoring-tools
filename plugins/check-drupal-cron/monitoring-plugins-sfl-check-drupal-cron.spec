%define raw_name       check-drupal-cron
%define name           monitoring-plugins-sfl-%{raw_name}
%define version        0.1.0
%define release        1
%define command_name   check_drupal_cron

Name:           %{name}
Version:        %{version}
Release:        %{release}
Summary:        Alignak plugin to check the Drupal cron service
...
%description
Alignak plugin to check the Drupal cron service
...
%changelog
* Tue Jun 30 2015 Frédéric Vachon <frederic.vachon@savoirfairelinux.com> - 2015.6.30.12.18
- Initial package
