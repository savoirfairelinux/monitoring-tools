...
Name:           monitoring-plugins-sfl-check-drupal-cron
Version:        2015.5.25.10.33
Release:        1%{?dist}
Summary:        A plugin to monitor Drupal cron service

License:        GPLv3
URL:            https://github.com/savoirfairelinux/monitoring-tools
Source0:        https://github.com/savoirfairelinux/monitoring-tools/monitoring-plugins-sfl-check-drupal-cron_%{version}.orig.tar.gz
...
%prep
%setup -q -n monitoring-plugins-sfl-check-drupal-cron
...
%{__install} -p -m0755 check_drupal_cron %{buildroot}/%{_libdir}/monitoring/plugins/sfl
...
%{python_sitelib}/shinkenplugins/plugins/drupal_cron
%{_libdir}/monitoring/plugins/sfl/check_drupal_cron
%docdir
%{_docdir}/monitoring/plugins/%{name}
%{_mandir}/man1/monitoring/plugins/%{name}

%changelog
* Mon May 25 2015 Frédéric Vachon <frederic.vachon@savoirfairelinux.com> - 2015.5.25.10.33
- Initial package