...
#
%define raw_name    check_libvirt_stats
%define name        check-libvirt-stats
...
License: GPL v3
Summary: Shinken plugin from SFL. Guest and host statistics from libvirt API
...
%{__cp} -pr check_libvirt_stats %{buildroot}/%{_libdir}/shinken/plugins/check_libvirt_stats
%{__cp} -pr libvirtstat.py %{buildroot}/%{_libdir}/shinken/plugins/libvirtstat.py
...
%{_libdir}/shinken/plugins/check_libvirt_stats
%{_libdir}/shinken/plugins/libvirtstat.py
%doc
