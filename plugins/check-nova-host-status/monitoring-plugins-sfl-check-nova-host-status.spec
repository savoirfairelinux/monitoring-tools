%define raw_name       check-nova-host-status
%define name           monitoring-plugins-sfl-%{raw_name}
%define version        0.4.0
%define release        1
%define command_name   check_nova_host_status

Name:           %{name}
Version:        %{version}
Release:        %{release}
Summary:        Alignak plugin to check the current host status from Nova
...
%description
Check the current host status from Nova
