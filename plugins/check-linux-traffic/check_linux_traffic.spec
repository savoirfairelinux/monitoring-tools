...
#
%define raw_name    check_linux_traffic
%define name        check-linux-traffic
...
License: GPL v3
Summary: Shinken plugin from SFL. Check traffic on linux hosts using _proc_net_dev
...
%{__cp} -pr check_linux_traffic %{buildroot}/%{_libdir}/shinken/plugins/check_linux_traffic
...
%{_libdir}/shinken/plugins/check_linux_traffic
%doc
