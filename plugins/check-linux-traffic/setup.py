...
description = 'Check Linux traffic'
long_description = ('''Check Linux traffic''')

#############################################################################

setup(
    name='shinkenplugins.plugins.linux_traffic',
    ...
    entry_points="""
    [console_scripts]
    check_linux_traffic = shinkenplugins.plugins.linux_traffic:main
    """,
)
