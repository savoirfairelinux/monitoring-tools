...
Name:           monitoring-plugins-sfl-check-drupal-views
Version:        2015.5.25.17.20
Release:        1%{?dist}
Summary:        A plugin to monitor Drupal Views module

License:        GPLv3
URL:            https://github.com/savoirfairelinux/monitoring-tools
Source0:        https://github.com/savoirfairelinux/monitoring-tools/monitoring-plugins-sfl-check-drupal-views_%{version}.orig.tar.gz
...
%description
A plugin to monitor Drupal Views module
More information is available on Github:
https://github.com/savoirfairelinux/sfl-monitoring-tools

%prep
%setup -q -n monitoring-plugins-sfl-check-drupal-views
...
%{__install} -p -m0755 check_drupal_views %{buildroot}/%{_libdir}/monitoring/plugins/sfl
...
%{python_sitelib}/shinkenplugins/plugins/drupal_views
%{_libdir}/monitoring/plugins/sfl/check_drupal_views
%docdir
%{_docdir}/monitoring/plugins/%{name}
%{_mandir}/man1/monitoring/plugins/%{name}

%changelog
* Mon May 25 2015 Frédéric Vachon <frederic.vachon@savoirfairelinux.com> - 2015.5.25.17.20
- Initial package