...
long_description = ('''A plugin to monitor Drupal Views module''')

#############################################################################

setup(
    name='shinkenplugins.plugins.drupal_views',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_drupal_views = shinkenplugins.plugins.drupal_views:main
    """
)