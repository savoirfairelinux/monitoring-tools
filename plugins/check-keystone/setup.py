...
description = 'A Shinken plugin to check the OpenStack KeyStone service'
long_description = (''' .. ''')


setup(
    name='shinkenplugins.plugins.keystone',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_keystone = shinkenplugins.plugins.keystone:main
    """,
)
