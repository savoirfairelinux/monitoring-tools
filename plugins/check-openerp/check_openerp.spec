...
#
%define raw_name    check_openerp
%define name        check-openerp
...
License: GPL v3
Summary: Shinken plugin from SFL. Check OpenERP using a web scenario
...
%{__cp} -pr check_openerp %{buildroot}/%{_libdir}/shinken/plugins/check_openerp
...
%{_libdir}/shinken/plugins/check_openerp
%doc
