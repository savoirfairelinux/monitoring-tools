...
import check_reactionner_health
...
class TestPlugin(unittest.TestCase):
    ...
    def test_help(self):
        ...
        sys.argv = [sys.argv[0]]
        sys.argv.append('-h')
        self.do_tst(3, """^check_reactionner_health""")
    ...
    def test_version(self):
        ...
        sys.argv = [sys.argv[0]]
        sys.argv.append('-V')
        self.do_tst(3, "^check_reactionner_health.py v%s" % check_reactionner_health.PLUGIN_VERSION)

    def do_tst(self, return_val, pattern_to_search):
        try:
            out = StringIO()
            sys.stdout = out
            check_reactionner_health.main()
        except SystemExit, e:
