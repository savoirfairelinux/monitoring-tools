...
long_description = ('''Check Drupal core version for known vulnerabilities''')

#############################################################################

setup(
    name='shinkenplugins.plugins.drupal_core',
    version="1.0",
    ...
    entry_points="""
    [console_scripts]
    check_drupal_core = shinkenplugins.plugins.drupal_core:main
    """
)