...
License: GPL v3
Summary: Shinken plugin from SFL. Generic pack for radius check
...
%description 
Shinken plugin from SFL. Generic pack for radius check
...
%changelog
* Wed Feb 26 2014 Sebastien Coavoux <sebastien.coavoux@savoirfairelinux.com>
- Initial Release
