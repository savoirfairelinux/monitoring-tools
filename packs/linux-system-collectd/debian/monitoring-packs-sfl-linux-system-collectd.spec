...
%define version     2015.2.19.17.55
%define release     1
...
Release:    %{release}
License: GPL v3
Summary: Standard linux collectd passive checks, like CPU, RAM and disk space. Checks are done by triggers on collected data. Started from collectd community module
