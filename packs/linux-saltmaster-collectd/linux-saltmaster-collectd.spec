...
License: GPL v3
Summary: Shinken plugin from SFL. Pack to monitor the salt master service on a linux
...
%description 
Shinken plugin from SFL. Pack to monitor the salt master service on a linux
