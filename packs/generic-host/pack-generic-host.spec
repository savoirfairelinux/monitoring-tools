...
License: GPL v3
Summary: Shinken plugin from SFL. Generic pack for all hosts
...
%description 
Shinken plugin from SFL. Generic pack for all hosts
...
%changelog
* Thu Mar 13 2014 Thibault Cohen <thibault.cohen@savoirfairelinux.com>
- Initial Release
