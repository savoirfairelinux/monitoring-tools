...
License: GPL v3
Summary: Shinken plugin from SFL. Passive check for Active Directory
...
%description 
Shinken plugin from SFL. Passive check for Active Directory
...
%changelog
* Thu May 08 2014 Thibault Cohen <thibault.cohen@savoirfairelinux.com>
- Initial Release
