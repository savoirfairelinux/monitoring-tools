...
License: GPL v3
Summary: Shinken plugin from SFL. Pack to monitor radius service on a Linux server
...
%description 
Shinken plugin from SFL. Pack to monitor radius service on a Linux server
