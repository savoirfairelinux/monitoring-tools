...
License: GPL v3
Summary: Shinken plugin from SFL. Windows MsSQL active checks
...
%description 
Shinken plugin from SFL. Windows MsSQL active checks
...
%changelog
* Wed Feb 19 2014 Thibault Cohen <thibault.cohen@savoirfairelinux.com>
- Initial Release
