...
License: GPL v3
Summary: Shinken plugin from SFL. CheckMK Multisite active checks with HTTP requests
...
%description 
Shinken plugin from SFL. CheckMK Multisite active checks with HTTP requests
...
%changelog
* Thu Feb 20 2014 Thibault Cohen <thibault.cohen@savoirfairelinux.com>
- Initial Release
