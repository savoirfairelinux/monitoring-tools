...
License: GPL v3
Summary: Shinken plugin from SFL. Pack to monitor the sophos service on a windows
...
%description 
Shinken plugin from SFL. Pack to monitor the sophos service on a windows
