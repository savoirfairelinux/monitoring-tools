...
latex_documents = [
  ('linux-system-snmp', 'linux-system-snmp.tex', u'linux-system-snmp Documentation',
...
man_pages = [
    ('linux-system-snmp', 'monitoring-packs-sfl-linux-system-snmp', u'linux-system-snmp Documentation',
