%define raw_name    openstack-host
...
Release:    %{release}
License: GPL v3
Summary: Alignak pack for monitoring OpenStack hosts based on Ceilometer metrics
...
%description
Alignak pack for monitoring OpenStack hosts based on Ceilometer metrics
