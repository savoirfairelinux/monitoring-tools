...
License: GPL v3
Summary: Shinken plugin from SFL. Pack to monitor number of infected servers on a sophos
...
%description 
Shinken plugin from SFL. Pack to monitor number of infected servers on a sophos
