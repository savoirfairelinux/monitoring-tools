...
License: GPL v3
Summary: Shinken plugin from SFL. Pack for NTP on linux with collectd
...
%description 
Shinken plugin from SFL. Pack for NTP on linux with collectd
...
%changelog
* Tue Mar 04 2014 Sebastien Coavoux <sebastien.coavoux@savoirfairelinux.com>
- Initial Release
