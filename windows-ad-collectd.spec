...
License: GPL v3
Summary: Shinken plugin from SFL. Pack to monitor the active directory services on a windows
...
%description 
Shinken plugin from SFL. Pack to monitor the active directory services on a windows
